# ----------------------------------------------------------------------------------------------------------------------
# This script contains functions for feature preparation
# ----------------------------------------------------------------------------------------------------------------------
...
def add_feature_columns(features, columns, file_name):
	...
	for column in columns:
		if column not in extra_data.columns:
			raise RuntimeError('Column does not exist in extra feature data')
